...
float Wave(float3 positionOS, float amplitude, float speed, float waveLength, float2 direction, float k)
{
...
Varyings Vertex (Attributes input)
{
    ...
    float h1 = Wave(vertex, _Amplitude1, _Speed1, _WaveLength1, _Direction1.xy, 1);
    float h2 = Wave(vertex, _Amplitude2, _Speed2, _WaveLength2, _Direction2.xy, 1.5);
    float h3 = Wave(vertex, _Amplitude3, _Speed3, _WaveLength3, _Direction3.xy, 2);
    vertex.y += (h1 + h2 + h3);
